...
| Auditable delivery package | Bundle, manifest, acceptance summary and status summary carry deterministic file inventory and SHA-256 evidence. | `tools/run_cn_delivery_acceptance.py`, `tools/build_cn_delivery_bundle.py`, `tools/verify_cn_delivery_artifacts.py`, `tools/summarize_cn_delivery_status.py`. | Delivery evidence proves software-package integrity, not the correctness of a customer's tax position. |
