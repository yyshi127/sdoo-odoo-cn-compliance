...
- production sign-off evidence validation generated by `tools/validate_cn_signoff_evidence.py` when human approvals are complete, including blocked objective areas when sign-off evidence is missing or invalid;
