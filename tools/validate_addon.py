...
def validate_china_compliance_workbench(manifest: dict[str, object]) -> None:
    ...
    for required in (
        ...
        "cn_remediation_rescan_stage",
        "_search_cn_remediation_rescan_stage",
    ...
    for required in (
        ...
        "cn_filing_center_archive_state",
        "_search_cn_filing_center_archive_state",
        "action_cn_open_workbench_filing_center",
    ...
    for required in (
        ...
        "test_remediation_tracker_search_view_exposes_rescan_filters",
        ...
        "test_risk_closure_state_is_searchable",
        "test_risk_center_search_view_exposes_closure_filters",
    ...
    for required in (
        ...
        "test_filing_center_archive_state_is_searchable",
        "test_filing_center_search_view_exposes_archive_readiness_filters",
        "china_filing_center",
...
def validate_delivery_objective_coverage() -> None:
    ...
    for required in (
        ...
        "customer-visible limitation statement",
    ...
    for required in (
        ...
        "test_delivery_status_markdown_lists_production_owner_summary",
        ...
        "test_missing_remediation_and_report_scope_blocks_ux_walkthrough",
    ...
    for required in (
        ...
        "workbench, risk center, remediation tracker, controlled AI guidance, filing/payment archive, report readiness and formal compliance report pages",
        "report readiness and formal compliance report",
        "CHINA_UAT_WALKTHROUGH_SCRIPT.md",
        "Official-source freshness monitoring result, latest monitor run integrity and 64-character SHA-256 result checksum, changed or failed run disposition, local jurisdiction review and governance summary reference",
        "latest monitor run integrity and 64-character SHA-256 result checksum",
        "64-character SHA-256 result checksum",
        "changed or failed run disposition",
        "source governance summary",
        "Customer target-period, posted accounting, invoice/filing/payment/payroll dataset",
        "open high/critical risk",
        "customer-visible limitation statement",
        "acquisition or authorization basis",
        '"objective_areas"',
        '"addresses_blockers"',
