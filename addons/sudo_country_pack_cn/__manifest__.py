{
    ...
    "data": [
        ...
        "data/reconciliation_source_monitoring_cron.xml",
        ...
        "views/workbench_simplified_views.xml",
        ...
        "views/navigation_views.xml",
    ],
    "assets": {
        "web.assets_backend": [
            "sudo_country_pack_cn/static/src/scss/workbench.scss",
        ],
    },
